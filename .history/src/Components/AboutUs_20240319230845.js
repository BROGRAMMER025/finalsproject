      ...
      <div className="about-us-content sm:px-2">
        ...
        <div className='section mt-20'>
            ...
            <div className='image1 ml-10 flex justify-center'>
                <img alt="https://www.freepik.com/free-photo/customer-experience-creative-collage_25179069.htm#fromView=search&page=1&position=12&uuid=6ccc5351-fc5c-42bc-9736-20f6f0413782" alt="..." className="w-full h-auto" />
            </div>
        </div>
