      ...
      <div className="about-us-content sm:px-2">
        ...
        <div className='text'>
          ...
          <div className='image2 ml-10 flex justify-center'>  
            <img alt="https://www.freepik.com/free-vector/seo-analytics-concept-illustration_28772290.htm#fromView=search&page=1&position=13&uuid=0fbc20a2-d81a-4071-9229-acfcd2bfe616"/>                                                    
          </div>
        </div>
